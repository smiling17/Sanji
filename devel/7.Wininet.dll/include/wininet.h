...
#define INTERNET_FLAGS_MASK                                       \
  (INTERNET_FLAG_RELOAD | INTERNET_FLAG_RAW_DATA |                \
   ...
   INTERNET_FLAG_NEED_FILE | INTERNET_FLAG_TRANSFER_BINARY |      \
...
//#ifndef TOC_LIB
//
//INTERNETAPI HINTERNET WINAPI
//    InternetOpenA(LPCSTR, DWORD, LPCSTR, LPCSTR, DWORD);
//INTERNETAPI HINTERNET WINAPI
//    InternetOpenW(LPCWSTR, DWORD, LPCWSTR, LPCWSTR, DWORD);
...
//
//INTERNETAPI HINTERNET WINAPI InternetConnectA(HINTERNET,
//                                              LPCSTR,
//                                              INTERNET_PORT,
//                                              LPCSTR,
//                                              LPCSTR,
...
//                                              DWORD,
//                                              DWORD_PTR);
//INTERNETAPI HINTERNET WINAPI InternetConnectW(HINTERNET,
//                                              LPCWSTR,
//                                              INTERNET_PORT,
//                                              LPCWSTR,
//                                              LPCWSTR,
...
//INTERNETAPI HINTERNET WINAPI
//    InternetOpenUrlW(HINTERNET, LPCWSTR, LPCWSTR, DWORD, DWORD, DWORD_PTR);
//#define InternetOpenUrl WINELIB_NAME_AW(InternetOpenUrl)
//
//BOOLAPI InternetReadFile(HINTERNET, LPVOID, DWORD, LPDWORD);
//INTERNETAPI BOOL WINAPI InternetReadFileExA(HINTERNET,
//                                            LPINTERNET_BUFFERSA,
//                                            DWORD,
//                                            DWORD_PTR);
//INTERNETAPI BOOL WINAPI InternetReadFileExW(HINTERNET,
//                                            LPINTERNET_BUFFERSW,
//                                            DWORD,
//                                            DWORD_PTR);
...
//#ifndef TOC_LIB
//
//INTERNETAPI DWORD WINAPI
//    InternetSetFilePointer(HINTERNET, LONG, PVOID, DWORD, DWORD_PTR);
...
//#ifndef TOC_LIB
//
//INTERNETAPI INTERNET_STATUS_CALLBACK WINAPI
...
//
//INTERNETAPI HINTERNET WINAPI
//    FtpFindFirstFileA(HINTERNET, LPCSTR, LPWIN32_FIND_DATAA, DWORD, DWORD_PTR);
//INTERNETAPI HINTERNET WINAPI
//    FtpFindFirstFileW(HINTERNET, LPCWSTR, LPWIN32_FIND_DATAW, DWORD, DWORD_PTR);
...
//
//INTERNETAPI HINTERNET WINAPI
//    FtpOpenFileA(HINTERNET, LPCSTR, DWORD, DWORD, DWORD_PTR);
//INTERNETAPI HINTERNET WINAPI
//    FtpOpenFileW(HINTERNET, LPCWSTR, DWORD, DWORD, DWORD_PTR);
...
//#ifndef TOC_LIB
//
//BOOLAPI GopherCreateLocatorA(LPCSTR,
//                             INTERNET_PORT,
//                             LPCSTR,
//                             LPCSTR,
//                             DWORD,
//                             LPSTR,
//                             LPDWORD);
//BOOLAPI GopherCreateLocatorW(LPCWSTR,
//                             INTERNET_PORT,
//                             LPCWSTR,
//                             LPCWSTR,
//                             DWORD,
...
//
//INTERNETAPI HINTERNET WINAPI GopherFindFirstFileA(HINTERNET,
//                                                  LPCSTR,
//                                                  LPCSTR,
//                                                  LPGOPHER_FIND_DATAA,
//                                                  DWORD,
//                                                  DWORD_PTR);
//INTERNETAPI HINTERNET WINAPI GopherFindFirstFileW(HINTERNET,
//                                                  LPCWSTR,
//                                                  LPCWSTR,
//                                                  LPGOPHER_FIND_DATAW,
//                                                  DWORD,
...
//
//INTERNETAPI HINTERNET WINAPI
//    GopherOpenFileA(HINTERNET, LPCSTR, LPCSTR, DWORD, DWORD_PTR);
//INTERNETAPI HINTERNET WINAPI
//    GopherOpenFileW(HINTERNET, LPCWSTR, LPCWSTR, DWORD, DWORD_PTR);
//#define GopherOpenFile WINELIB_NAME_AW(GopherOpenFile)
//
//#endif /* TOC_LIB (함수선언) */
//
//typedef BOOL(CALLBACK* GOPHER_ATTRIBUTE_ENUMERATORA)(LPGOPHER_ATTRIBUTE_TYPEA,
//                                                     DWORD);
//typedef BOOL(CALLBACK* GOPHER_ATTRIBUTE_ENUMERATORW)(LPGOPHER_ATTRIBUTE_TYPEW,
//                                                     DWORD);
//
...
//#ifndef TOC_LIB
//
//BOOLAPI GopherGetAttributeA(HINTERNET,
//                            LPCSTR,
//                            LPCSTR,
//                            LPBYTE,
//                            DWORD,
...
//                            DWORD_PTR);
//BOOLAPI GopherGetAttributeW(HINTERNET,
//                            LPCWSTR,
//                            LPCWSTR,
//                            LPBYTE,
//                            DWORD,
...
//#ifndef TOC_LIB
//
//INTERNETAPI HINTERNET WINAPI HttpOpenRequestA(HINTERNET,
//                                              LPCSTR,
//                                              LPCSTR,
//                                              LPCSTR,
//                                              LPCSTR,
...
//                                              DWORD,
//                                              DWORD_PTR);
//INTERNETAPI HINTERNET WINAPI HttpOpenRequestW(HINTERNET,
//                                              LPCWSTR,
//                                              LPCWSTR,
//                                              LPCWSTR,
//                                              LPCWSTR,
...
//
//INTERNETAPI BOOL WINAPI HttpSendRequestExA(HINTERNET,
//                                           LPINTERNET_BUFFERSA,
//                                           LPINTERNET_BUFFERSA,
//                                           DWORD,
//                                           DWORD_PTR);
//INTERNETAPI BOOL WINAPI HttpSendRequestExW(HINTERNET,
//                                           LPINTERNET_BUFFERSW,
//                                           LPINTERNET_BUFFERSW,
//                                           DWORD,
//                                           DWORD_PTR);
...
//#ifndef TOC_LIB
//
//INTERNETAPI BOOL WINAPI HttpEndRequestA(HINTERNET,
//                                        LPINTERNET_BUFFERSA,
//                                        DWORD,
//                                        DWORD_PTR);
//INTERNETAPI BOOL WINAPI HttpEndRequestW(HINTERNET,
//                                        LPINTERNET_BUFFERSW,
//                                        DWORD,
//                                        DWORD_PTR);
...
//
//INTERNETAPI DWORD WINAPI
//InternetErrorDlg(HWND, HINTERNET, DWORD, DWORD, LPVOID*);
//INTERNETAPI DWORD WINAPI InternetConfirmZoneCrossingA(HWND, LPSTR, LPSTR, BOOL);
//INTERNETAPI DWORD WINAPI InternetConfirmZoneCrossingW(HWND,
//                                                      LPWSTR,
//                                                      LPWSTR,
//                                                      BOOL);
...
//#ifndef TOC_LIB
//
//INTERNETAPI DWORD WINAPI PrivacySetZonePreferenceW(DWORD,
//                                                   DWORD,
//                                                   DWORD,
//                                                   LPCWSTR);
//INTERNETAPI DWORD WINAPI
//    PrivacyGetZonePreferenceW(DWORD, DWORD, LPDWORD, LPWSTR, LPDWORD);
//
//#endif /* TOC_LIB (함수선언) */
//
...
//
//BOOLAPI CommitUrlCacheEntryA(LPCSTR,
//                             LPCSTR,
//                             FILETIME,
//                             FILETIME,
//                             DWORD,
...
//                             LPCSTR,
//                             LPCSTR);
//BOOLAPI CommitUrlCacheEntryW(LPCWSTR,
//                             LPCWSTR,
//                             FILETIME,
//                             FILETIME,
//                             DWORD,
...
//
//BOOLAPI RetrieveUrlCacheEntryFileA(LPCSTR,
//                                   LPINTERNET_CACHE_ENTRY_INFOA,
//                                   LPDWORD,
//                                   DWORD);
//BOOLAPI RetrieveUrlCacheEntryFileW(LPCWSTR,
...
//    RetrieveUrlCacheEntryStreamA(LPCSTR,
//                                 LPINTERNET_CACHE_ENTRY_INFOA,
//                                 LPDWORD,
//                                 BOOL,
//                                 DWORD);
//INTERNETAPI HANDLE WINAPI
//    RetrieveUrlCacheEntryStreamW(LPCWSTR,
//                                 LPINTERNET_CACHE_ENTRY_INFOW,
//                                 LPDWORD,
//                                 BOOL,
//                                 DWORD);
...
//
//BOOLAPI GetUrlCacheEntryInfoExA(LPCSTR,
//                                LPINTERNET_CACHE_ENTRY_INFOA,
//                                LPDWORD,
//                                LPSTR,
//                                LPDWORD,
//                                LPVOID,
//                                DWORD);
//BOOLAPI GetUrlCacheEntryInfoExW(LPCWSTR,
//                                LPINTERNET_CACHE_ENTRY_INFOW,
//                                LPDWORD,
//                                LPWSTR,
//                                LPDWORD,
...
//
//BOOLAPI GetUrlCacheGroupAttributeA(GROUPID,
//                                   DWORD,
//                                   DWORD,
//                                   LPINTERNET_CACHE_GROUP_INFOA,
//                                   LPDWORD,
//                                   LPVOID);
//BOOLAPI GetUrlCacheGroupAttributeW(GROUPID,
//                                   DWORD,
//                                   DWORD,
...
//
//BOOLAPI SetUrlCacheGroupAttributeA(GROUPID,
//                                   DWORD,
//                                   DWORD,
//                                   LPINTERNET_CACHE_GROUP_INFOA,
//                                   LPVOID);
//BOOLAPI SetUrlCacheGroupAttributeW(GROUPID,
//                                   DWORD,
//                                   DWORD,
//                                   LPINTERNET_CACHE_GROUP_INFOW,
//                                   LPVOID);
...
//
//INTERNETAPI HANDLE WINAPI
//    FindFirstUrlCacheEntryExA(LPCSTR,
//                              DWORD,
//                              DWORD,
//                              GROUPID,
//                              LPINTERNET_CACHE_ENTRY_INFOA,
...
//                              LPVOID);
//INTERNETAPI HANDLE WINAPI
//    FindFirstUrlCacheEntryExW(LPCWSTR,
//                              DWORD,
//                              DWORD,
//                              GROUPID,
//                              LPINTERNET_CACHE_ENTRY_INFOW,
...
//
//BOOLAPI FindNextUrlCacheEntryExA(HANDLE,
//                                 LPINTERNET_CACHE_ENTRY_INFOA,
//                                 LPDWORD,
//                                 LPVOID,
//                                 LPDWORD,
//                                 LPVOID);
//BOOLAPI FindNextUrlCacheEntryExW(HANDLE,
//                                 LPINTERNET_CACHE_ENTRY_INFOW,
//                                 LPDWORD,
//                                 LPVOID,
//                                 LPDWORD,
...
//
//INTERNETAPI HANDLE WINAPI FindFirstUrlCacheEntryA(LPCSTR,
//                                                  LPINTERNET_CACHE_ENTRY_INFOA,
//                                                  LPDWORD);
//INTERNETAPI HANDLE WINAPI FindFirstUrlCacheEntryW(LPCWSTR,
//                                                  LPINTERNET_CACHE_ENTRY_INFOW,
//                                                  LPDWORD);
...
//typedef BOOL(CALLBACK* pfnInternetGetProxyInfo)(LPCSTR,
//                                                DWORD,
//                                                LPSTR,
//                                                DWORD,
//                                                LPSTR*,
